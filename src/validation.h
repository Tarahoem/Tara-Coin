...
CAmount CollectCarbonFee(const CTransaction& tx, const Consensus::Params& consensus);
...
/** Slash a validator for fraud — burns 3 coins, redistributes to honest validators */
