...
enum opcodetype
{
    ...
    OP_NOP9 = 0xb8,
    OP_NOP10 = 0xb9,
    OP_STAKE = 0xf1, // Tara staking
    OP_MERCHANT = 0xf2, // Shop payment marker
    OP_BET = 0xf3,  // Gaming/metaverse bet transaction
    OP_ESCROW = 0xf4,  // Freelance escrow transaction
    OP_API_ACCESS = 0xf5,  // External app data access fee
    OP_CARBON = 0xf6,      // Carbon credit verification
    OP_SHOP = 0xf7,        // Shop/merchant payment
    OP_TOKEN = 0xf8,       // Token creation
    OP_VALIDATOR_DATA = 0xf9,
