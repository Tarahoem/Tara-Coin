...
{
    const char* pszTimestamp = "Rand manipulation case: The banks may walk, says analyst - FAWZ";
    const CScript genesisOutputScript = CScript() << "04048a4d371d7eb2cb08e286d63bcc85c707003301539fd085d20249e603907c5d5f180f8fde0e68e00fea0e933ba277a4023538ef33a132e31e5ecd454341b43f9d"_hex << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.ministryInjectionPubKey = "04044870436f1c35515b5c294d986b55aefc795a53e33e2e610c2b9e57375e324a7375999ee1c06e5cbcc953a67dad5750053b88009a8abc16ac4feb138a683e7234";
        consensus.lpInjectionAmount = 3000000 * COIN;
        consensus.lpInjectionBlock = 720;
        nDefaultPort = 8333;
        ...
        assert(genesis.hashMerkleRoot == uint256{"6f507513906378acfa2d2e41de8c36024f40a771fabe774d39adad1dd1242466"});
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"398991eb901f2c3009e20b401f03838ab47836503dce783018a0fef0687694a3"});
        assert(genesis.hashMerkleRoot == uint256{"6f507513906378acfa2d2e41de8c36024f40a771fabe774d39adad1dd1242466"});
